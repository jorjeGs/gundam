...
for ($i = 0; $i < count($arreglo); $i++) {
  ...
  values($id_venta," . $arreglo[$i]['Id'] . "," . $arreglo[$i]['Cantidad'] . "," . $arreglo[$i]['Precio'] . "," . $arreglo[$i]['Cantidad'] * $arreglo[$i]['Precio'] . ")
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">Tu compra ha sido completada con exito.</p>
            <p><a href="product.php" class="btn btn-sm btn-primary">Seguir comprando</a></p>
          </div>
        </div>
      </div>
    </div>
